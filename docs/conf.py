...
"""
openai-xblock documentation build configuration file.
...
project = 'openai-xblock'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openai-xblock'
...
html_context = {
    ...
    "github_repo": 'openai-xblock',  # Repo name
...
#
# html_title = 'openai-xblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'OpenAI XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openai'),
                os.path.join(root_path, 'openai/migrations')])
